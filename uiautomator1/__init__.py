...
class JsonRPCError(Exception):
    ...
    def __init__(self, code, message):
        self.code = int(code)
        self.message = message.encode("utf-8") #Kevin add encode("utf-8") to support Chinese word
...
#     __apk_files = ["libs/app-uiautomator.apk", "libs/app-uiautomator-test.apk","libs/Utf7Ime.apk"]
...
class AutomatorDevice(object):
    ...
    def double_click(self, x=500, y=500):
  # set ack timeout
...
#         self(*args, **kwargs).click()
    ...
    def gesture(self, start1, start2, *args, **kwargs):
        ...
        def to(obj_self, end1, end2, steps=100):
            ...
            return self.server.jsonrpc.gesture(self.selector, s1, s2, e1, e2, steps)
